...
class App(customtkinter.CTk):
    def __init__(self, *args, **kwargs):
        ...
        # ----------------------- WIDGETS -----------------------
        # logs
        #self.widget_logs = customtkinter.CTkTextbox(self.frame_logs.tab(self.config.get("strings", "logs")), width=self.width_frame * 3, height=self.height_frame * 3)
        ...
        #self.select_theme.grid(row=0, column=0, padx=0, pady=0, sticky="nsew")
        ...
        #self.btn_run.grid(row=0, column=1, columnspan=1, padx=0, pady=0, sticky="nsew")
